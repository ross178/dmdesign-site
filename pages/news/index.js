...
export default function News(){return(
  <div className="min-h-screen bg-white text-neutral-900">
    <Nav/>
    <Section>
      <h1 className="text-3xl sm:text-4xl font-semibold">In The News</h1>
      <p className="mt-3 text-neutral-600">Press, articles, and social features. The Herald feature is coming soon.</p>
    </Section>
    <Footer/>
  </div>
);}
